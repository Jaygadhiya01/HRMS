...
class EmployeeForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["permanent_address"].widget.attrs["autocomplete"] = "permanent_address"
...
class EmployeeBankDetailsForm(ModelForm):
    ...
    permanent_address = forms.CharField(widget=forms.Textarea(attrs={"rows": 2, "cols": 40}))
...
excel_columns = [
    ...
    ("state", trans("State")),
    ("city", trans("City")),
    ("permanent_address", trans("permanent_address")),
    ("zip", trans("Zip Code")),
